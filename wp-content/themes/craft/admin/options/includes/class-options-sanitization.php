...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'craft' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'craft' ),
		'repeat-y'  => __( 'Repeat Vertically', 'craft' ),
		'repeat'    => __( 'Repeat All', 'craft' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'craft' ),
		'top center'    => __( 'Top Center', 'craft' ),
		'top right'     => __( 'Top Right', 'craft' ),
		'center left'   => __( 'Middle Left', 'craft' ),
		'center center' => __( 'Middle Center', 'craft' ),
		'center right'  => __( 'Middle Right', 'craft' ),
		'bottom left'   => __( 'Bottom Left', 'craft' ),
		'bottom center' => __( 'Bottom Center', 'craft' ),
		'bottom right'  => __( 'Bottom Right', 'craft')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'craft' ),
		'fixed'  => __( 'Fixed in Place', 'craft')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'craft' ),
		'italic'      => __( 'Italic', 'craft' ),
		'bold'        => __( 'Bold', 'craft' ),
		'bold italic' => __( 'Bold Italic', 'craft' )
		);
